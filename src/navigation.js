...
class Navigation extends React.Component {
  render() {
    const { count, pass, fail, skip, time, todo, toggleShow } = this.props;
    ...
    return (<div className="navbar navbar-white">
      <div className="container">
        ...
        <div className="nav">
          ...
          <a onClick={() => toggleShow("all") }><span className="badge badge-default tooltip-bottom" data-tooltip="Total Count"> <i className="text-white fa fa-tasks"/> </span>&nbsp;{ count } </a>
          <a onClick={() => toggleShow("success") }><span className="badge badge-success tooltip-bottom" data-tooltip="Total Pass"> <i className="text-white fa fa-check"/> </span>&nbsp;{ pass } </a>
          <a onClick={() => toggleShow("failed") }><span className="badge badge-danger tooltip-bottom" data-tooltip="Total Fail"> <i className="text-white fa fa-times"/> </span>&nbsp;{ fail } </a>
